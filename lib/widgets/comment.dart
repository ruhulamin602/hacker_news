...
import 'package:news/widgets/time.dart';
...
class Comment extends StatelessWidget {
        ...
        final children = <Widget>[
          Card(
            ...
            margin: EdgeInsets.only(
                right: 16.0, left: (depth + 1) * 16.0, top: 5.0),
            child: ListTile(
  ...
  Widget buildText(ItemModels item) {
    ...
    final text3 = DescriptionTextWidget(text: text1, textCount: 160);
    return text3;
  }
}
